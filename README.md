...
2020 - 2021: "React + React Native"
  ...
  projects: "react-hooks-playground | react-design-patterns | taskflow-app | rn-navigation-masterclass | rn-animations-cookbook | medtrack-mobile"
2022: "TALL Stack + Alpine.js (Laravel ecosystem)"
  focus: "Livewire, Alpine.js, Tailwind CSS, real-time UIs"
  projects: "livewire-crud-masterclass | invoice-pilot | alpine-essentials | tall-stack-starter | tall-dashboard-kit | snap-feedback"
2022 - 2023: "FastAPI"
...
2023 → now: "Polishing & Deepening"
  focus: "Staying current — Django 6, Livewire 4, React 19, Python 3.14 | Type safety, testing, performance, clean architecture"
```
